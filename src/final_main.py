...
class MainRun:
	...
	#self.target_pose.position.x = map_range(self.next_point[0],0,384,-10,10)
	#self.target_pose.position.y = map_range(self.next_point[1],0,384,-10,10)
	self.target_pose.position.x = self.next_point[0]
	self.target_pose.position.y = self.next_point[1]
